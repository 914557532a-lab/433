...
* *********************************************************/
void CMT2300A_GoSleep(void)
{ unsigned int Count = 10000;
	CMT2300A_WriteReg(CMT2300A_CUS_MODE_CTL, CMT2300A_GO_SLEEP);
	do{
		if((CMT2300A_ReadReg(CMT2300A_CUS_MODE_STA) &0x0F) == CMT2300A_STA_SLEEP)
		{	Count = 0x00;	}
	}while(Count--);
}
...
* @return  TRUE or FALSE
* *********************************************************/
void CMT2300A_GoStby(void)
{ unsigned int Count = 10000;
    CMT2300A_WriteReg(CMT2300A_CUS_MODE_CTL, CMT2300A_GO_STBY);
	do{
		if((CMT2300A_ReadReg(CMT2300A_CUS_MODE_STA) &0x0F) == CMT2300A_STA_STBY)
		{	Count = 0x00;	}
	}while(Count--);
}
...
* @return  TRUE or FALSE
* *********************************************************/
void CMT2300A_GoTFS(void)
{ unsigned int Count = 10000;
	CMT2300A_WriteReg(CMT2300A_CUS_MODE_CTL, CMT2300A_GO_TFS);
	do{
		if((CMT2300A_ReadReg(CMT2300A_CUS_MODE_STA) &0x0F) == CMT2300A_STA_TFS)
		{	Count = 0x00;	}
	}while(Count--);
}
...
* @return  TRUE or FALSE
* *********************************************************/
void CMT2300A_GoRFS(void)
{ unsigned int Count = 10000;
    CMT2300A_WriteReg(CMT2300A_CUS_MODE_CTL, CMT2300A_GO_RFS);
	do{
		if((CMT2300A_ReadReg(CMT2300A_CUS_MODE_STA) &0x0F) == CMT2300A_STA_RFS)
		{	Count = 0x00;	}
	}while(Count--);
}
/*! ********************************************************
...
* @return  TRUE or FALSE
//* *********************************************************/
void CMT2300A_GoTx(void)
{ unsigned int Count = 10000;
    CMT2300A_WriteReg(CMT2300A_CUS_MODE_CTL, CMT2300A_GO_TX);
	do{
		if((CMT2300A_ReadReg(CMT2300A_CUS_MODE_STA) &0x0F) == CMT2300A_STA_TX)
		{	Count = 0x00;	}
	}while(Count--);
}
...
* @return  TRUE or FALSE
* *********************************************************/
void CMT2300A_GoRx(void)
{ unsigned int Count = 10000;
   CMT2300A_WriteReg(CMT2300A_CUS_MODE_CTL, CMT2300A_GO_RX);
	do{
		if((CMT2300A_ReadReg(CMT2300A_CUS_MODE_STA) &0x0F) == CMT2300A_STA_RX)
		{	Count = 0x00;	}
	}while(Count--);
}
/*! ********************************************************
...
* *********************************************************/
void CMT2300A_Init_Reg(void)
{unsigned char tmp;

    CMT2300A_SoftReset();
    Cmt2300A_Delay_us(2000);
    CMT2300A_GoStby();
    ...
    CMT2300A_EnableLfosc(0);// Diable LFOSC
...
* *********************************************************/
void CMT2300A_ConfigRegBank(unsigned char code *base_addr, unsigned char len)
{unsigned char i,ConfigArray[2];

    for(i=0; i<len; i++)
	{	ConfigArray[0] = *base_addr++;
		ConfigArray[1] = *base_addr++;
		CMT2300A_WriteReg(ConfigArray[0],ConfigArray[1]);
	}
}
