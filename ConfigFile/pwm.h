...
void PWM_InterruptCfg(PWM_Channel_TypeDef pwm_ch,PWM_TIE_TypeDef tie,PWM_ZIE_TypeDef zie,
						  PWM_PIE_TypeDef pie,PWM_NIE_TypeDef nie,unsigned char pwmcmax	);
...
extern xdata unsigned int PWM_DivDat;
extern xdata unsigned int PWM_DutyDat;
